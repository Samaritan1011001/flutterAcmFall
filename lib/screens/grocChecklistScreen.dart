...
class _ChecklistScreen extends State<ChecklistScreen>{
  ...
  List<Grocery> myGrocery = [
    Grocery(title:"My Milk", date: DateTime.now(),isDone: false, user: User(id:"A1", color:Colors.green) ),
    Grocery(title:"My Bread", date: DateTime.now(), isDone:false, user: User(id:"A2", color:Colors.red)),
    Grocery(title:"My Eggs", date: DateTime.now(), isDone:false, user: User(id:"A3", color:Colors.blue)),
    Grocery(title:"My Chocolate", date: DateTime.now(), isDone:false, user: User(id:"A3", color:Colors.yellow)),
   ...
   return Scaffold(
     ...
     Column(
         ...
         Container(
           ...
           child: Text("My List", style: TextStyle(fontFamily: 'SFProText', fontSize: 16)),
           ...
           child: ListView.builder(
                 ...
                 itemBuilder: (context, index){
                   return Container(
                       ...
                       margin: const EdgeInsets.only(left: 58.0, right: 16.0),

                       height:100,
                       width: 200,
                       constraints: BoxConstraints(minWidth: 301.0, minHeight: 69.0),
                    ...
                    child: ListTile(
                        title: Text(myGrocery[index].title, style: TextStyle(fontSize: 19, fontFamily: 'SFProText'))
                    )
                   );
                }),
              )])

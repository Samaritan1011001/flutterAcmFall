          ...
          Container(
              child: Row(
                ...
                InkWell(
                    onTap: () {
                      FocusScope.of(context).requestFocus(new FocusNode());
                      String dateFormat = _eventDate != null
                          ? '${_eventDate.month}-${_eventDate.day}-${_eventDate.year}'
                          : null;
                      String timeFormat = _eventTime != null
          ...
          child: Column(children: <Widget>[
            ...
            widget.setDate
                ? Column(children: <Widget>[
                    Container(
                        color: Colors.white,
                        height: widget.setDate ? 130 : 0,
                        child: CupertinoDatePicker(
                            initialDateTime: widget.eventDate != null
                                ? widget.eventDate
                                : DateTime.now(),
                    ...
                    widget.setTime
                        ? Container(
                            ...
                            height: 130,
                            child: CupertinoDatePicker(
                                initialDateTime: widget.eventTime != null
                                    ? widget.eventTime
                                    : DateTime.now(),

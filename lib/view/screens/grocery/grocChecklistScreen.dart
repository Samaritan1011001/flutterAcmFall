          ...
          if (res.doc.data()["isActive"]) {
            ...
            firestoreInstance
              ...
              List<ChecklistItemModel> checklistitems = data["checklist"]
                  .map<ChecklistItemModel>((item) => ChecklistItemModel(
                      text: item["text"], isChecked: item['isChecked']))
                  .toList();
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return CheckboxListTile(
                          title: Text(
                              sharedGroceries[index].checklist.items[0].text,
                              style: TextStyle(
                                  fontFamily: 'SFProText', fontSize: 18)),
                          subtitle: Text(
                              DateFormat('MM/dd/yyyy – kk:mm').format(
                                  sharedGroceries[index].checklist.date),
                              style: TextStyle(
                          ...
                          secondary: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      fit: BoxFit.fill,
                                      image: NetworkImage(
                                          sharedGroceries[index].user.photo)))),
                              ...
                              children: <Widget>[
                                Text("My Grocery List",
                                    style: TextStyle(
                                        ...
                                        fontWeight: FontWeight.bold,
                                        color: Colors.white)),
                                userGroceries.length > 0
                                    ? Text(
                                        "${userGroceries.length} " +
                                            (userGroceries.length == 1
                                                ? "grocery list"
                                                : "grocery lists"),
                                        style: TextStyle(
                                            fontSize: 18,

...
class ChecklistCreationScreen extends StatefulWidget {
  @override
  _ChecklistCreationScreen createState() => _ChecklistCreationScreen(callback:callback);

  final ListCallback callback;
  ChecklistCreationScreen({this.callback});
}
...
class _ChecklistCreationScreen extends State<ChecklistCreationScreen> {
  final ListCallback callback;
  _ChecklistCreationScreen({this.callback});
